...
<div class="wrapper">
    <div class="row">
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #B7C4CF; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #EEE3CB; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #D7C0AE; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #FFB1B1; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #D1D8C5; color: white;">
                <div class="counter">
        ...
        <div class="col-4 col-m-4 col-sm-4">
            <div class="card" style="background-color: #CDE8E5; color: white;">
                <div class="counter">
